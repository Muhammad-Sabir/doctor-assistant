          ...
          <div className="grid gap-2">
            ...
            <div className="text-gray-500">
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange(value, "hospitalId")
                }
                required
              >
                <SelectTrigger
                  className={`${
                    inputErrors.hospitalId ? "border-red-500" : ""
                  }`}
                >
              ...
              {inputErrors.hospitalId && (
                <div
                  aria-live="assertive"
                  className="flex mt-2 text-sm text-red-500"
                >
                  <BiSolidError color="red" className="mt-1 mr-1" />{" "}
                  {inputErrors.hospitalId}
                </div>
              )}
            </div>
          ...
          <div className="grid gap-2">
            ...
            <div className="text-gray-500">
              <Select
                ...
                onValueChange={(value) =>
                  handleSelectChange(value, "dayOfWeek")
                }
                required
              >
                <SelectTrigger
                  className={`${inputErrors.dayOfWeek ? "border-red-500" : ""}`}
                >
                ...
                <div key={index} className="flex items-center gap-3 mb-2 ml-2">
                  <div className="flex flex-col">
                    <Label
                      ...
                      className="mb-2 text-sm font-normal text-gray-600"
                    >
                      From
                    </Label>
                    <Input
                  ...
                  <div className="flex mt-5 text-gray-600">-</div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <Input
                      ...
                      value={slot.duration}
                      onChange={(e) =>
                        handleTimeSlotChange(index, "duration", e.target.value)
                      }
                      required
                      className="w-32"
                      placeholder="(minutes)"
                  ...
                  {formData.timeSlots.length === 1 ? (
                    <span onClick={addTimeSlot}>
                      <IoAddCircleOutline
                        color="green"
                        className="w-5 h-5 font-bold mt-7"
                      />
                    </span>
                  ) : (
                    <>
                      {index === formData.timeSlots.length - 1 && (
                        <>
                          ...
                          <span onClick={() => removeTimeSlot(index)}>
                            <IoCloseCircleOutline
                              color="red"
                              className="w-5 h-5 -ml-1 font-bold mt-7"
                            />
                          </span>
                        </>
                      )}
